...
<div id="header">
  <h1 id="logo">
    <a href="/" on:click={closeNav}><img src={logo} alt="Logo" /></a>
  </h1>

  <ul id="nav" class:visible={showNav}>
    <li><a href="/" on:click={closeNav} class:active={$page.url.pathname === '/'}>Accueil</a></li>
    ...
    <li><a href="/contact" on:click={closeNav} class:active={$page.url.pathname.includes('/contact')}>Contact</a></li>
  </ul>
